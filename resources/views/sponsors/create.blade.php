    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <form action="{{ route('sponsors.store') }}" method="POST" class="p-6">
                    @csrf
                    <!-- Nume Sponsor -->
                    <div class="mb-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="url" id="logo" name="website" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                    </div>
